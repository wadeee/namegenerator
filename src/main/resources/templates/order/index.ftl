                    ...
                    <v-col>
                        ...
                        <v-card-text>
                            ...
                            >
                                ...
                                <v-select
                                        v-model="birthdayHour"
                                        :items="hours"
                                        label="时(生日)"
                                        required
                                ></v-select>
                                <v-select
                                        v-model="birthdayMinute"
                                        :items="minutes"
                                        label="分(生日)"
                                        required
                                ></v-select>
    ...
    new Vue({
        ...
        methods: {
            ...
            updateBirthday() {
                ...
                console.log(this.birthdayHour)
                console.log(this.birthdayMinute)
                this.orderForm.birthday = new Date(this.birthdayDate.substr(0,4), this.birthdayDate.substr(5,2), this.birthdayDate.substr(8,2), this.birthdayHour, this.birthdayMinute)
                console.log(this.orderForm.birthday)
            },
        },
        watch: {
            ...
            'birthdayHour': function () {
                this.updateBirthday()
            },
            'birthdayMinute': function () {
                this.updateBirthday()
            },
